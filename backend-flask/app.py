...
# debugging connection to honeycomb - 1 of 2 
# by adding local logs (in container shell / eg. exec ) 
...
# debugging connection to honeycomb - 2 of 2 
# by adding local logs (in container shell / eg. exec )
# show this in the logs within the backend flask app (STDOUT) 
# while implementing Rollbar he hide thses next 2 lines in order to avoid to many logs 
...
# adding Rollbar endpoint to show a test msg of error 
